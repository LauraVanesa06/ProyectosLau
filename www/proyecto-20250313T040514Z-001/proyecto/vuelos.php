    ...
    <div class="container" id="vuelos">
        <div class="table_header">
            ...
            <form action="vuelos.php" method="post">
                    <input type="text" class="form-control" name="destino" placeholder="Ingrese su destino" required>
            </form>
         ...
         <table>
            <thead>
                ...
                <th scope="col"></th>
                <th scope="col"><h5><strong>Horario</strong></h5></th>
                <th scope="col"></th>
                <th scope="col"><h5><strong>Destino</strong></h5></th>
